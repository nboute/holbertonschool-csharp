...
/// <summary>
/// Generic class Objs that creates a collection of type T objects that can be iterated through using foreach
/// </summary>
/// <typeparam name="T"></typeparam>
public class Objs<T> : IEnumerable
{
    /// <summary>
